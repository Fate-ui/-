...
__DEFINE__(1641607197965, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1641607197966,"./event-store":1641607197967}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1641607197966, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1641607197967, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1641607197966,"./utils":1641607197968}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1641607197968, function(require, module, exports) {
...
return __REQUIRE__(1641607197965);
})()

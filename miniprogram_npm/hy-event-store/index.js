...
__DEFINE__(1642317007896, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1642317007897,"./event-store":1642317007898}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642317007897, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1642317007898, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1642317007897,"./utils":1642317007899}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642317007899, function(require, module, exports) {
...
return __REQUIRE__(1642317007896);
})()
